    ...
    <div class="form-container">
      ...
      <div class="form-box"><br >
        ...
        <div style="overflow:scroll;">
          ...
          <img src="/images/aero-press.jpg" alt="AeroPress Coffee | Photo by Kave Kostolo on Pixabay" style="height:40px; width:40px; align:center; border:1px solid gray;">&emsp;&emsp;&emsp;
          <img src="/images/french-press.jpg" alt="French Press Coffee | Photo by Sonny Ravesteij on Unsplash" style="height:40px; width:40px; align:center; border:1px solid gray;"><br ><br >
